...
public class Data {
    ...
    static public final double PLAYER_WIDTH = PLAYER_IMAGE.getWidth();
    static public final double PLAYER_HEIGHT = PLAYER_IMAGE.getHeight();
    static public final Position PLAYER_SPAWN_POSITION = new Position(BOARD_WIDTH/2, BOARD_HEIGHT - PLAYER_IMAGE.getHeight());
    static public final double PLAYER_SPEED_X = 1.5;
    ...
    static public final double ENEMY_REGULAR_SPEED_X = 0.6;
    ...
    static public final int ENEMY_REGULAR_COUNT = 10;
    static public final double ENEMY_REGULAR_DROP_GAIN_CHANCE = 5;
    static public final int ENEMY_REGULAR_GIFT_SCORE = 100;

    //Enemy Boss
    static public final Image ENEMY_BOSS_IMAGE = new Image("Enemy_boss_x2.png");
    static public final double ENEMY_BOSS_WIDTH = ENEMY_BOSS_IMAGE.getWidth();
    static public final double ENEMY_BOSS_HEIGHT = ENEMY_BOSS_IMAGE.getHeight();
    static public final double ENEMY_BOSS_SPEED_X = 0.6;
    static public final double ENEMY_BOSS_SPEED_Y = ENEMY_BOSS_HEIGHT + 5;
    static public final int ENEMY_BOSS_HEALTH = 5;
    static public final Gun ENEMY_BOSS_GUN = new Gun(new ProjectileBossEnemyCreator());
    static public final double ENEMY_BOSS_DROP_GAIN_CHANCE = 10;
    static public final int ENEMY_BOSS_GIFT_SCORE = 500;

    //Projectile
    static public final double PROJECTILE_SPEED_Y = 15;
    ...
    static public final Image PROJECTILE_ENEMY_BOSS_IMAGE = new Image("Enemy_regular_projectile.png");
    static public final int PROJECTILE_ENEMY_REGULAR_DAMAGE = 1;
    static public final Image PROJECTILE_ENEMY_REGULAR_IMAGE = new Image("Enemy_boss_projectile_x2.png");
